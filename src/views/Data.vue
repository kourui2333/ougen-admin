 ...
 * @LastEditTime: 2021-08-30 11:05:00
...
let dataMenu = reactive({
  ...
  dataMenuList: [
    { isActive: true, dataMenuName: "数据概览", url: "/home/data/pageone" },
    { isActive: false, dataMenuName: "统计报表", url: "/home/data/pagetwo" },
    { isActive: false, dataMenuName: "综合分析", url: "/home/data/pagethree" },
  ],
});
